...
export default function PanicButton() {
  ...
  return (
    <motion.button
      ...
      className="fixed bottom-16 right-2 z-30 w-14 h-14 rounded-full bg-red-600 shadow-lg shadow-red-600/30 flex items-center justify-center hover:bg-red-700 active:scale-95 transition-all"
      whileTap={{ scale: 0.9 }}
